...
export default function HeroSearch() {
  return (
    <form className="flex items-center gap-3 bg-white dark:bg-background p-6 rounded-[5px] shadow-[16px_41px_89px_0_rgba(129,129,129,0.16)] ">
      {/* Job title */}
      ...
      <div className="relative flex-1">
        ...
        <Input
          ...
          className="pl-10 h-12 border-none ring-0"
        />
      </div>
